...
export async function updateDocReview(id: string, patch: Partial<Pick<DocReview, "review" | "reviewSimplified" | "reviewKeyTerms" | "docContent" | "docTitle" | "history">>): Promise<DocReview> {
